...
<html lang="en">
	<head>
		...
		<title>Layout Hidden Sidebar Left | SENTIR - Responsive admin and dashboard UI kits template</title>
	...
	<body class="tooltips">
		...
		<div class="wrapper">
			...
			<div class="top-navbar">
				<div class="top-navbar-inner">
					...
					<div class="top-nav-content">
						...
						<div class="btn-collapse-sidebar-left-2">
			...
			<!-- BEGIN SIDEBAR LEFT -->
			<div class="sidebar-left sidebar-nicescroller hsl-toggle">
				<ul class="sidebar-menu">
					...
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="layout-hidden-sidebar-left.html">Hidden sidebar left<span class="label label-danger span-sidebar">NEW</span></a></li>
			...
			<!-- BEGIN PAGE CONTENT -->
			<div class="page-content hsl-toggle">
