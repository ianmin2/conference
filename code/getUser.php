			...
			<div class="page-content">
				...
				<!-- BEGIN ALERT -->
					<div class="alert alert-success alert-bold-border fade in alert-dismissable row" >
						...
						<div  class="col-lg-12"> 
						<p></p><div class="center-block  row col-lg-2 darker" style="font-size: 20px; font-family:cursive; ">SEARCH USING</div>
						<div class="center-block text-center row col-lg-10" style="font-size: 20px; font-family:cursive; ">
							<div class="col-sm-1 bg-info">Name</div>
							<div class="col-sm-3 bg-success" style="color: black;">telephone number </div>
							<div class="col-sm-3 bg-primary">receipt number</div>
							<div class="col-sm-2 bg-warning" style="color: black;">email address</div>
							<div class="col-sm-3 bg-danger">passport number</div>
						</div>
						<br><br>
