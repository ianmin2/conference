	...
	<div class=" block-center  col-lg-11 container-fluid">
		...
		<div class="row ">
			...
			<div class="col-lg-12">
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w1a"><option selected>Workshop 1a</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w3a"><option selected>Workshop 3a</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w5a"><option selected>Workshop 5a</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-1 border  text-danger">
					<select id="_w7a"><option selected>Workshop 7a</option> 
			<?php
		...
		<div class="row ">
			...
			<div class="col-lg-12">
				...
				<div class="col-sm-2 border">&nbsp;</div>
				<div class="col-sm-2 border  text-danger">
					<select id="_w1b"><option selected>Workshop 1b</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w3b"><option selected>Workshop 3b</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w5b"><option selected>Workshop 5b</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 dark darkb">&nbsp;</div>
				<div class="col-sm-1 border  text-danger">
					<select id="_w7b"><option selected>Workshop 7b</option>
			<?php
		...
		<div class="row ">
			...
			<div class="col-lg-12">
				...
				<div class="col-sm-2 border  text-primary">
					<select id="_p1"><option selected>lPenary 1</option>
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-primary">
					<select id="_p4"><option selected>Plenary 4</option>
			<?php
		...
		<div class="row ">
			...
			<div class="col-lg-12">
				...
				<div class="col-sm-2 border">&nbsp;</div>
				<div class="col-sm-2 border  text-danger">
					<select id="_w2a"><option selected>Workshop 2a</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w4a"><option selected>Workshop 4a</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w6a"><option selected>Workshop 6a</option> 
			<?php
		...
		<div class="row ">
			...
			<div class="col-lg-12">
				...
				<div class="col-sm-2 ">&nbsp;</div>
				<div class="col-sm-2 border  text-danger">
					<select id="_w2b"><option selected>Workshop 2b</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w4b"><option selected>Workshop 4b</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-danger">
					<select id="_w6b"><option selected>Workshop 6b</option> 
			<?php
		...
		<div class="row ">
			...
			<div class="col-lg-12">
				...
				<div class="col-sm-2 border">&nbsp;</div>
				<div class="col-sm-2 border  text-primary">
					<select id="_p2"><option selected>Plenary 2</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-primary">
					<select id="_p3"><option selected>Plenary 3</option> 
			<?php
			...
			?>
				...
				<div class="col-sm-2 border  text-primary">
					<select id="_p5"><option selected>Plenary 5</option> 
			<?php
				...
				$.post(
						...
						function( data, result ){
							...
							if(d.response == "SUCCESS"){
								localStorage.setItem("current", _atendee);
