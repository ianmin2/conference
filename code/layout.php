...
<div class=" block-center  col-lg-12 container-fluid" >
	...
	<div class="col-lg-12">
		...
		<div class="col-sm-2 border  text-danger">W 1a</div>
		<div class="col-sm-2 border  text-danger">W 3a</div>
		<div class="col-sm-2 border  text-danger">W 5a</div>
		<div class="col-sm-2 dark darkb">&nbsp;</div>
		<div class="col-sm-1 border  text-danger">W 7a</div>
	...
	<div class="col-lg-12">
		...
		<div class="col-sm-2 border">&nbsp;</div>
		<div class="col-sm-2 border  text-danger">W 1b</div>
		<div class="col-sm-2 border  text-danger">W 3b</div>
		<div class="col-sm-2 border  text-danger">W 5b</div>
		<div class="col-sm-2 dark darkb">&nbsp;</div>
		<div class="col-sm-1 border  text-danger">W 7b</div>
	...
	<div class="col-lg-12">
		...
		<div class="col-sm-2 border text-primary">PLENARY</div>
		<div class="col-sm-2 dark darkb">&nbsp;</div>
		<div class="col-sm-1 border">W </div>
	...
	<div class="col-lg-12">
		...
		<div class="col-sm-2 border">&nbsp;</div>
		<div class="col-sm-2 border  text-danger">W 2a</div>
		<div class="col-sm-2 border  text-danger">W 4a</div>
		<div class="col-sm-2 border  text-danger">W 6a</div>
		<div class="col-sm-2 dark darkb">&nbsp;</div>
	...
	<div class="col-lg-12">
		...
		<div class="col-sm-2 ">&nbsp;</div>
		<div class="col-sm-2 border  text-danger">W 2b</div>
		<div class="col-sm-2 border  text-danger">W 4b</div>
		<div class="col-sm-2 border  text-danger">W 6b</div>
