...
$val = '
		<div class="alert alert-success alert-bold-border block-center fade in alert-dismissable" >
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="_nationality" style="min-width: 200px; min-height: 35px; text-align: center;" >
  ...
  <option value="zimbabwean">Zimbabwean</option>
			...
			<br><br><input type="text" id="_telephone" placeholder="Guest Telephone" style="min-width: 200px; min-height: 35px; text-align: center;" >  
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="_church" placeholder="Church" style="min-width: 200px; min-height: 35px; text-align: center;" > 
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="_division" placeholder="Church Conference" style="min-width: 200px; min-height: 35px; text-align: center;" >
			
			<br><br><select id="_gender" style="min-width: 200px; min-height: 35px; text-align: center;">
				<option value="" selected >Gender</option>
				<option value="M" >Male</option>
				<option value="F">Female</option>
			</select>
			
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="_email" placeholder="email address" style="min-width: 200px; min-height: 35px; text-align: center;" >
...
$val = '
		<div class="alert alert-info alert-bold-border block-center fade in alert-dismissable" >
			...
			<br><br><select id="_time" style="min-width: 200px; min-height: 35px; text-align: center;">
				...
				<option value="0545HRS" >05:45</option>
				...
				<option value="1015HRS" >10:15</option>
				<option value="1115HRS" >11:15</option>
				<option value="1145HRS" >11:45</option>
				...
				<option value="1930HRS" >19:30</option>
